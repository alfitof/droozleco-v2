      ...
      <div>
        ...
        <div class="flex gap-0 max-w-sm">
          <input
            ...
            class="flex-1 bg-drz-black text-drz-white font-mono text-xs px-4 py-4 outline-none placeholder:text-drz-muted focus:placeholder:text-drz-muted/50 border-2 border-drz-black"
          />
          <button
